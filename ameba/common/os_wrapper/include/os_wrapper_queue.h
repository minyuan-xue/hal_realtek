...
/**
 * @brief  Delete a queue - freeing all the memory allocated for storing of items placed on
 *         the queue.
 ...
 *         Messages are received from the queue and removed from the queue, so the queue's
 *         state changes.
 * @param  p_handle: Address of the message queue.
